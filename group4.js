...
const GROUP4_STARTBEAT = 96; // Put the correct number here..
/**
 ...
 * 
 */
var group4_objects = (t) => {
        var stuffpoints = [];
        stuffpoints.push( [ [-3,0,0], [-3,10,0], 1, 1] );
        stuffpoints.push( [ [2,0,0],  [0,10,0], 1, 1] );
        stuffpoints.push( [ [2,0,0],  [4,10,0], 1, 1] );
